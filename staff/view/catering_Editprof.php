...
<html lang="en">
<head>
    <title>Catering Edit profile</title>
...
<?php
    ...
    if ($_SESSION['roles'] === 'catering') {
        ...
        if ($result && $result->num_rows > 0) {
            ...
            echo "<br>";
            echo '<form method="POST" action="../controller/catering_Editprofpro.php" onsubmit="return getproform();">
            <table>
            <tr>
                            <td>
        ...
        echo '<p><a href="../view/catering_dash.php">Back to Dashboard</a></p>';
    } else {
