...
<html lang="en">
<head>
    <title>Waiter Edit profile</title>
...
<?php
    ...
    if ($_SESSION['roles'] === 'waiter') {
        ...
        if ($result && $result->num_rows > 0) {
            ...
            echo "<br>";
            echo '<form method="POST" action="../controller/waiter_Editprofpro.php" onsubmit="return getproform();">
            <table>
            <tr>
                            <td>
        ...
        echo '<p><a href="../view/waiter_dash.php">Back to Dashboard</a></p>';
    } else {
