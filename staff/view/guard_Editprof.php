...
<html lang="en">
<head>
    <title>Guard Edit profile</title>
...
<?php
    ...
    if ($_SESSION['roles'] === 'guard') {
        ...
        if ($result && $result->num_rows > 0) {
            ...
            echo "<br>";
            echo '<form method="POST" action="../controller/guard_Editprofpro.php" onsubmit="return getproform();">
            <table>
            <tr>
                            <td>
        ...
        echo '<p><a href="../view/guard_dash.php">Back to Dashboard</a></p>';
    } else {
